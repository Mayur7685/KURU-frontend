const styles = {
  ...
  hocContentBox: 'flex flex-1 justify-between bg-gradient-to-r from-customOrange to-customPurple py-8 sm:px-12 px-8 flex-col',
  ...
  btn: 'px-4 py-2 rounded-lg bg-[#ff5c1f] w-fit text-white font-rajdhani font-bold',
